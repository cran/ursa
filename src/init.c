...
static R_NativePrimitiveArgType internalMarginWithBackground_t[] = {
...
static const R_CMethodDef CEntries[] = {
   ...
   {"internalMarginWithBackground", (DL_FUNC) &internalMarginWithBackground, 5, internalMarginWithBackground_t},
